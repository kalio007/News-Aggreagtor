    ...
    return (
        ...
        <div className ='coins'>
           ...
           <div className="watcoin">
            ...
            <div>
                <p className="price">$33.59</p>
                <p className="percent">3.3%</p>
            </div> 
            </div>
            <div className ='coins'>
           <div className="watcoin">
